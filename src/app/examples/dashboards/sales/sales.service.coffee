  ...
  SalesService = ->
    ...
    generateOrder = (date) ->
      ...
      names = [
        ...
        'Cleta Kuhn'
        'Ruby Shields'
        'Dr. Moises Beahan DDS'
        'Miss Shanel Jenkins DVM'
        'Kitty Heller DVM'
        'Vivien Sauer'
        'Clara Cremin'
        'Eunice Morissette'
        ...
        'Manley Roberts'
        'Ruby Shields'
        'Miss Lavada Runolfsson'
        'Kira Dooley'
        'Meredith Ebert DDS'
      ]
      emails = [
        'johnson.althea@gleichner.net'
        'will.rhea@weber.biz'
        'roslyn75@keebler.com'
        'okon.glenda@hamill.com'
        'estroman@cruickshank.org'
        'victoria41@hartmann.com'
        'bogisich.janice@wilkinson.com'
        'bryce97@kris.com'
        'noe59@king.com'
        'wiza.litzy@kozey.com'
        'oconner.cortney@gmail.com'
        'kub.fannie@hotmail.com'
        'adrian00@gutkowski.com'
        'justice69@yahoo.com'
        'torphy.toney@yahoo.com'
        'bogisich.janice@wilkinson.com'
        'oconner.cortney@gmail.com'
        'orval63@gmail.com'
        'jaime94@gmail.com'
        'olaf69@okeefe.com'
        'torphy.toney@yahoo.com'
        'bernhard.bruen@marvin.com'
        'otilia61@hotmail.com'
        'bogan.lelia@bins.info'
        'adrian00@gutkowski.com'
        'yazmin76@hotmail.com'
        'kglover@hotmail.com'
        'erick.hermann@larkin.net'
        'bernhard.bruen@marvin.com'
        'bradly90@corkery.info'
        'orval63@gmail.com'
        'olaf69@okeefe.com'
      ]
      order = 
